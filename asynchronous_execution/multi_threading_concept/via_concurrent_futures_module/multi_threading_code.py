...
# NOTE: when we are using context manager, it will automatically join all the threads before exiting the context manager. i.e., context manager will wait for all the threads to complete their execution before exiting from the context manager.
